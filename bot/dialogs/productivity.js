...
var db = require("__dirname/app/routes/wrappers.js")
...
lib.dialog('actions/block', [
    ...
    function (session, results) {
        ...
        db.blockURL(session.userData.res,session.userData.email,session.userData.password,session.dialogData.name,session.dialogData.website,session.dialogData.duration);
        session.endDialog();
...
lib.dialog('actions/session',[
    ...
    function (session, results, next) {
        ...
        db.session(session.userData.res,session.userData.email,session.userData.password,session.dialogData.name,session.dialogData.time);
        session.endDialog();
        //Communication goes here!
...
lib.dialog('actions/unblock', [
    ...
    function (session, results, next) {
        ...
        db.unblockURL(session.userData.res,session.userData.email,session.userData.password,session.dialogData.name,session.dialogData.website);
        session.endDialog();
...
lib.dialog('actions/unsession',[
    ...
    function (session, results, next) {
        ...
        db.unsession(session.userData.res,session.userData.email,session.userData.password,session.dialogData.name);
    	session.endDialog();
